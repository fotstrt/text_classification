...
CSV_FILE = "../csv_data/"
FREQ_DIST_FILE = CSV_FILE + 'train_data-processed-freqdist.pkl'
BI_FREQ_DIST_FILE = CSV_FILE + 'train_data-processed-freqdist-bi.pkl'
TRAIN_PROCESSED_FILE = CSV_FILE + 'train_data-processed.csv'
TEST_PROCESSED_FILE = CSV_FILE + 'test_data-processed.csv'
